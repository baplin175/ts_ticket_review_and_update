"""
Pass 4 — Intervention Aggregator.

Computes engineering ROI metrics from Pass 4 results stored in the DB:
...
def aggregate_from_results(results: List[Dict[str, Any]]) -> Dict[str, Any]:
    """Compute aggregation metrics from a list of Pass 4 result dicts.
...
def aggregate_from_db() -> Dict[str, Any]:
    """Compute aggregation metrics from all successful Pass 4 rows in the DB.
...
def write_artifacts(
    ...
    *,
    ...
    """Write Pass 4 JSON artifacts to the output directory.

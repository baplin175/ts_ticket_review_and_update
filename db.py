        ...
        with conn.cursor() as cur:
            cur.execute("""
                INSERT INTO ticket_llm_pass_results (
                    ticket_id, ticket_number, product_name, pass_name, prompt_version, model_name,
                    ...
                    (SELECT product_name FROM tickets WHERE ticket_id = %s),
                    %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, now()
                )
                RETURNING id;
            """, (
                ticket_id, ticket_id, ticket_id, pass_name, prompt_version, model_name,

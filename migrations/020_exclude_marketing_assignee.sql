-- Migration 020 — Also exclude assignee='Marketing' tickets everywhere.
-- Marketing-assigned tickets are not real support tickets and must be
-- ignored in all analytics, views, and backlog calculations.
-- Combines with existing status='Open' exclusion from migration 019.

-- ═══════════════════════════════════════════════════════════════════
-- 051 — Surface DO alignment fields in ticket analytics views
-- ═══════════════════════════════════════════════════════════════════

DROP VIEW IF EXISTS vw_operational_open_tickets CASCADE;
...
SELECT
    ...
    -- DO alignment
    da.aligned           AS do_aligned,
    da.mismatch_label    AS do_mismatch_label,
    da.explanation       AS do_alignment_explanation,
    -- metrics
    m.action_count,
...
LEFT JOIN vw_latest_ticket_do_alignment da ON da.ticket_id = t.ticket_id
